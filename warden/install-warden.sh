...
curl -s https://raw.githubusercontent.com/warden-protocol/wardenprotocol/main/tests/testdata/snapshot-base/config/genesis.json -o $HOME/.warden/config/genesis.json
